import 'package:clothes_shop_project/main/catalog/catalog_page.dart';
import 'package:flutter/material.dart';

class KidsTabWidget extends StatelessWidget {
  final String type;
  final String title;
  ...
  Widget buildCategoryTile(BuildContext context, String label, String imagePath) {
    return InkWell(

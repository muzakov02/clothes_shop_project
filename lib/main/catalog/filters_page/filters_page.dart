          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('Colors', style: TextStyle(fontSize: 18, fontFamily: 'Metropolis',)),
                ),
                Container(
                  width: double.infinity,
                  height: 80,
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('Sizes', style: TextStyle(fontSize: 18, fontFamily: 'Metropolis',)),
                ),
                SizedBox(height: 10),
                Container(
                  width: double.infinity,
                      ...
                      children: sizes.map((size) {
                        ...
                        return ChoiceChip(
                          label: Text(
                            size,
                            style: TextStyle(
                              fontSize: 12,  fontFamily: 'Metropolis',
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('Category', style: TextStyle(fontSize: 18, fontFamily: 'Metropolis',)),
                ),
                SizedBox(height: 10),
                Container(
                  width: double.infinity,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      boxShadow: [BoxShadow(color: Colors.white)]),
                  child: ListTile(
                    title: Text('Brand', style: TextStyle(fontSize: 18, fontFamily: 'Metropolis',)),
